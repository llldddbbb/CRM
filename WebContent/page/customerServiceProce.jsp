...
<script type="text/javascript">
	...
	var url;
 	...
 	function openCustomerServiceProceDialog(){
 		...
 		url="${pageContext.request.contextPath}/customerService/save.do?state=已处理&id="+row.id
 	}
 	
 	function closeCustomerServiceProceDialog(){
 		resetValues();
		$("#dlg").dialog("close");
 	}
...
<body style="margin: 1px">
	...
	rownumbers="true" url="${pageContext.request.contextPath}/customerService/list.do?state=已分配" fit="true" toolbar="#tb">
	<thead>
		<tr>
			...
			<th field="assigner" width="100" align="center" >分配人</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openCustomerServiceProceDialog()" class="easyui-linkbutton" iconCls="icon-fwcl" plain="true">服务处理</a>
		</div>
	</div>
		...
		<form id="fm" method="post">
			<table cellspacing="8px">
				...
				<tr>
					<td>服务处理:</td>
					<td colspan="4">
						<textarea rows="5" cols="49" id="serviceProce" name="serviceProce" class="easyui-validatebox" required="true"></textarea>
					</td>
				</tr>
				<tr>
					<td>处理人:</td>
				...
				<tr>
					<td colspan="4"></td>
					<td>
						<a href="javascript:saveCustomerServiceProce()" iconCls="icon-ok" class="easyui-linkbutton">保存</a>
						<a href="javascript:closeCustomerServiceProceDialog()" iconCls="icon-cancel" class="easyui-linkbutton">关闭</a>
					</td>
				</tr>
			</table>
		</form>
