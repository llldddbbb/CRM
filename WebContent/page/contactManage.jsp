...
<body style="margin: 15px">
	...
	<div id="p" class="easyui-panel" title="交往记录信息" style="height: 100px;width: 700px;padding:10px">
	...
	<table id="dg" title="交往记录管理" style="width:700px;height:250px"
        ...
        <thead>
            <tr>
                ...
                <th field="contactTime" width="50" editor="{type:'datebox',options:{required:true}}">交往时间</th>
                <th field="address" width="100" editor="{type:'validatebox',options:{required:true}}">交往地点</th>
