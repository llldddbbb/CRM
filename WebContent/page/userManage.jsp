 	...
 	function deleteUser(){
 		...
 		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗?",function(r){
 			if(r){
 				...
 				var strIds=ids.join(",")
 				$.post("${pageContext.request.contextPath}/user/delete.do",{ids:strIds},function(result){
 					var result=eval("("+result+")");
 					if(result.success){
...
<body style="margin: 1px">
	...
	rownumbers="true" url="${pageContext.request.contextPath}/user/list.do" fit="true" toolbar="#tb">
	<thead>
		<tr>
	...
	<div id="tb">
		...
		<div>
			&nbsp;用户名：&nbsp;<input type="text" id="s_userName" onkeyup="if(event.keyCode==13) searchUser()"/>
