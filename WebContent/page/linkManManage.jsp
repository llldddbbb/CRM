...
<body style="margin: 15px">
	...
	<div id="p" class="easyui-panel" title="销售机会信息" style="height: 100px;width: 700px;padding:10px">
	...
	<br/>
	<table id="dg" title="联系人管理" style="width:700px;height:250px"
            toolbar="#toolbar"  idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
                <th field="id" width="50">编号</th>
                <th field="linkName" width="50" editor="{type:'validatebox',options:{required:true}}">姓名</th>
                <th field="sex" width="100" editor="{type:'combobox',
                	options:{
                		valueField:'id',
                		textField:'name',
